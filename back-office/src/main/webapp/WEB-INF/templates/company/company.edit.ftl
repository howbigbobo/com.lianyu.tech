                ...
                <fieldset>
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" id="company_name" name="name" value="${(company.name)!}">
                    ...
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            <input type="text" id="company_slogan" name="slogan" value="${(company.slogan)!}">
                            <span class="help-inline">（必填）</span>
                        </div>
                    </div>
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            <input type="text" id="company_logo_url" name="logoUrl" value="${(company.logoUrl)!}">
                            <span class="help-inline">（必填）</span>
                        </div>
                    </div>
                    <div class="control-group success">
                        ...
                        <div class="controls">
                            <input type="text" id="company_domain" name="domain" value="${(company.domain)!}">
                            <span class="help-inline">（必填）</span>
                        </div>
                    </div>
